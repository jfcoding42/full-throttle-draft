...
function patchHtml(text){
 ...
 text=text.replace('</body>','<script src="./downmetric-ui.js?v=14"></script><script src="./league-mode.js?v=14"></script><script src="./dm-redraft.js?v=14"></script></body>');
 return text;
}
