...
function patchHtml(text){
 ...
 text=text.replace('</head>','<link rel="icon" type="image/png" sizes="32x32" href="./favicon-32.png?v=22"><link rel="icon" type="image/png" sizes="64x64" href="./favicon-64.png?v=22"><link rel="apple-touch-icon" sizes="180x180" href="./apple-touch-icon.png?v=22"><meta name="apple-mobile-web-app-title" content="DownMetric"></head>');
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=22"></script><script src="./league-mode.js?v=22"></script><script src="./dm-redraft.js?v=22"></script><script src="./downmetric-account.js?v=22"></script><script src="./downmetric-footer.js?v=22"></script><script src="./downmetric-picklog.js?v=22"></script><script src="./downmetric-theme.js?v=22"></script></body>');
 return text;
}
