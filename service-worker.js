...
function patchHtml(text){
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=18"></script><script src="./league-mode.js?v=18"></script><script src="./dm-redraft.js?v=18"></script><script src="./downmetric-account.js?v=18"></script><script src="./downmetric-footer.js?v=18"></script><script src="./downmetric-picklog.js?v=18"></script></body>');
 return text;
}
