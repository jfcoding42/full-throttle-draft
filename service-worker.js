...
function patchHtml(text){
 ...
 text=text.replace('</head>','<link rel="icon" type="image/png" href="./icon-192.png?v=21"><link rel="apple-touch-icon" sizes="180x180" href="./icon-192.png?v=21"><meta name="apple-mobile-web-app-title" content="DownMetric"></head>');
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=21"></script><script src="./league-mode.js?v=21"></script><script src="./dm-redraft.js?v=21"></script><script src="./downmetric-account.js?v=21"></script><script src="./downmetric-footer.js?v=21"></script><script src="./downmetric-picklog.js?v=21"></script><script src="./downmetric-theme.js?v=21"></script></body>');
 return text;
}
