...
function patchHtml(text){
 ...
 text=text.replace('<h1>🏈 DownMetric Football Draft Lab</h1>','<h1 style="display:flex;align-items:center;gap:10px"><img src="./icon-192.png?v=19" alt="DownMetric" style="width:42px;height:42px;border-radius:10px;flex:0 0 42px">DownMetric Draft Lab</h1>');
 text=text.replace('</head>','<link rel="icon" type="image/png" sizes="32x32" href="./favicon-32.png?v=19"><link rel="icon" type="image/png" sizes="64x64" href="./favicon-64.png?v=19"><link rel="apple-touch-icon" sizes="180x180" href="./apple-touch-icon.png?v=19"><meta name="apple-mobile-web-app-title" content="DownMetric"></head>');
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=19"></script><script src="./league-mode.js?v=19"></script><script src="./dm-redraft.js?v=19"></script><script src="./downmetric-account.js?v=19"></script><script src="./downmetric-footer.js?v=19"></script><script src="./downmetric-picklog.js?v=19"></script></body>');
 return text;
}
