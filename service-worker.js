...
function patchHtml(text){
 ...
 text=text.replace('<h1>🏈 DownMetric Football Draft Lab</h1>','<h1 style="display:flex;align-items:center;gap:10px"><img src="./icon-192.png?v=20" alt="DownMetric" style="width:42px;height:42px;border-radius:10px;flex:0 0 42px">DownMetric Draft Lab</h1>');
 text=text.replace('</head>','<link rel="icon" type="image/png" href="./icon-192.png?v=20"><link rel="apple-touch-icon" sizes="180x180" href="./icon-192.png?v=20"><meta name="apple-mobile-web-app-title" content="DownMetric"></head>');
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=20"></script><script src="./league-mode.js?v=20"></script><script src="./dm-redraft.js?v=20"></script><script src="./downmetric-account.js?v=20"></script><script src="./downmetric-footer.js?v=20"></script><script src="./downmetric-picklog.js?v=20"></script></body>');
 return text;
}
