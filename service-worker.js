...
function patchHtml(text){
 ...
 text=text.replace('</body>','<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script><script src="./downmetric-ui.js?v=15"></script><script src="./league-mode.js?v=15"></script><script src="./dm-redraft.js?v=15"></script><script src="./downmetric-account.js?v=15"></script></body>');
 return text;
}
